<template>
    <div class="box">
        <div class="box-header">
            <h3 class="box-title"><i class="fa fa-users"></i> Tabla de Categorias Latinos:</h3>
            <button type="button"
            class="btn btn-default btn-xs"
            data-tooltip="tooltip"
            title="Registrar Categoría"
            @click="openform('plus', 1)"
            v-if="can('categories_l.store')"><span class="glyphicon glyphicon-plus"></span></button>
            <button type="button"
            class="btn btn-default btn-xs"
            data-tooltip="tooltip"
        ...
        <div class="box-body">
            <div id="form-categories_l" class="col-md-8 col-md-offset-2" v-if="can(['categories_l.store', 'categories_l.update'])"">
            ...
            <rs-table id="categories_l" :tabla="tabla" uri="/category-l"></rs-table>
        </div>
    </div>
</template>
        ...
        data() {
            return {
                ...
                tabla: {
                    ...
                    { title: 'Categoría', field: 'category_latino_id', sortable: true },
                    { title: 'Subcategoría', field: 'name', sortable: true },
                    ],
                    options: [
                    { ico: 'fa fa-edit', class: 'btn-info', title: 'Editar Categoría', func: (id) => {this.openform('edit', 3, id); }, action: 'categories_l.update'},
                    { ico: 'fa fa-close', class: 'btn-danger', title: 'Borrar Categoría', func: (id) => {this.deleted('/category-l/'+id, this.$children[0].get, 'subcategory'); }, action: 'categories_l.destroy'},
                    ]
                }
            };
        },
