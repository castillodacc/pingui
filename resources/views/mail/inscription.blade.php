...
@section('content')
    <tr>
        <td
            style="padding: 5px 0 5px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px; text-align: justify;">
            ...
            @if ($data->method_pay == 1)
                <p>Si todavía tienes que realizar el pago por transferencia bancaria, recuerda introducir en el campo de
                    referencia los nombres de los participantes. </p>
            ...
            @endif
            <p>Para ver el listado de participantes <a href="{{ route('list', $data->tournament->slug) }}">haz click
                    aquí</a>.</p>
            <p>Para ver más información sobre la competición visita nuestra página web: <a
                    href="{{ url('/') }}">{{ url('/') }}</a></p>
