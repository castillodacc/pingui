<template>
  <div class="box">
    ...
    <div class="box-body">
      <div
        id="form-categories_l"
        class="col-md-8 col-md-offset-2"
        v-if="can(['categories_l.store', 'categories_l.update'])"
      >
...
export default {
  ...
  methods: {
    get: function () {
      axios.post("/categories-l").then((response) => {
    ...
    register: function () {
      ...
      if (this.form.cond == "plus") {
        axios.post(this.form.url, this.form.data).then((response) => {
        ...
        axios.put(this.form.url, this.form.data).then((response) => {
