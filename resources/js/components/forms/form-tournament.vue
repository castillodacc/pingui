      ...
      <div class="row">
        ...
        >
          <div class="col-md-10 col-md-offset-1">
            <div class="col-md-6" v-for="(input, i) in entries[0]" :key="i">
              <rs-input
                :name="input"
            ...
            <div class="col-md-6" style="height: 100px">
              <div class="checkbox" style="padding-top: 25px">
                ...
                >
                  ...
                  <b>{{ data.inscription ? "Abierta" : "Cerrada" }}</b> </label
                ><br />
                <small
                  id="inscriptionHelp"
                  class="form-text text-muted"
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="col-md-4" v-if="more_info_.type_id > 1">
                  <div class="form-group">
                    <label for="file" class="control-label">
                      <span class="edit"></span> Seleccione el archivo a
                      Guardar:
                    </label>
                    <input
                      id="file"
                      ...
                      @change="getFile"
                      :accept="
                        more_info_.type_id == 3 ? 'application/pdf' : '.csv'
                      "
                    />
                    <small
                      id="fileHelp"
                ...
                <div class="col-md-12">
                  <ul>
                    <li v-for="(m, i) in more_info" :key="i">
                      ...
                      <button
                        ...
                        class="btn btn-danger btn-xs"
                        @click="m.active = 1"
                        v-else-if="m.active != null && m.active == 0"
                      >
          ...
          <div class="col-md-12" v-if="prices.length">
            <div class="row">
              <div
                class="col-md-4"
                style="max-height: 400px; min-height: 400px; overflow: scroll"
              >
...
export default {
  ...
  methods: {
      ...
      if (this.price && this.p_category) {
        ...
        for (let i in this.hijos) {
          ...
          for (let o in this.prices) {
            if (
              data["category_id"] == this.prices[o]["category_id"] &&
    ...
    registrar() {
      ...
      if (this.$route.params.id) {
        axios.put("/tournament/" + this.data.id, this.data).then((response) => {
