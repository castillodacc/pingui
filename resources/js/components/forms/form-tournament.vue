<template>
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">
                <span :class="'glyphicon glyphicon-' + ico"></span> {{ title }}
            </h3>
        </div>
        <div class="box-body">
            <div class="row">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        >
                            <rs-input
                                ...
                                :msg="msg[input.id]"
                                @input="data[input.id] = arguments[0]"
                            ></rs-input>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                >
                                    ...
                                    <option
                                        ...
                                        :value="o.id"
                                        v-text="o.name"
                                        v-for="(o, i) in organizers"
                                    ></option>
                                </select>
                                <small
                                    id="organizer_idHelp"
                                    class="form-text text-muted"
                                    v-text="msg.organizer_id"
                                ></small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="start" class="control-label">
                                    <span class="edit"></span> Fecha de inicio
                                    de competición:
                                </label>
                                <date-picker
                                    id="start"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="end" class="control-label">
                                    <span class="edit"></span> Fecha final de
                                    competición:
                                </label>
                                <date-picker
                                    id="end"
                        ...
                        <div class="col-md-6">
                            <div class="checkbox">
                                ...
                                >
                                    ...
                                    />
                                    <span class="edit"></span> Inscripción:
                                    <b>{{
                                        data.inscription ? "Abierta" : "Cerrada"
                                    }}</b> </label
                                ><br />
                                <small
                                    id="inscriptionHelp"
                                    class="form-text text-muted"
                                    v-text="msg.inscription"
                                ></small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="hours" class="control-label">
                                    <span class="edit"></span> Horario del
                                    evento:
                                </label>
                        ...
                        <div class="col-md-6" style="height: 94px">
                            <div class="form-group">
                                <label for="info" class="control-label">
                                    <span class="edit"></span> Información del
                                    evento:
                                </label>
                                <input
                                    id="info"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="referee" class="control-label">
                                    <span class="edit"></span> Referees del
                                    evento:
                                </label>
                                <rs-multiselect
                                    v-model="data.referee_tournament"
                                ...
                                <div class="col-md-12">
                                    <ul>
                                        ...
                                        >
                                            ...
                                            ></a>
                                            -
                                            <span v-if="m.type_id == 1"
                                                >LINK</span
                                            >
                                            <span v-else-if="m.type_id == 2"
                                                >CSV</span
                                            >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" v-if="p_category == 2">
                                    <div class="form-group">
                                        ...
                                        <rs-multiselect
                                            v-model="hijos"
                                            :options="category_latinos_options"
                                            :multiple="true"
                                            :hide-selected="true"
                                            :close-on-select="false"
                                        ></rs-multiselect>
                                        <small
                                            id="subcategory_latinoHelp"
                                            class="form-text text-muted"
                                            v-text="msg.subcategory_latino"
                                        ></small>
                                    </div>
                                </div>
                                <div class="col-md-6" v-if="p_category == 3">
                                    <div class="form-group">
                                        ...
                                        <rs-multiselect
                                            v-model="hijos"
                                            :options="category_standars_options"
                                            :multiple="true"
                                            :hide-selected="true"
                                            :close-on-select="false"
                                        ></rs-multiselect>
                                        <small
                                            id="subcategory_standarHelp"
                                            class="form-text text-muted"
                                            v-text="msg.subcategory_standar"
                                        ></small>
                                    </div>
                                </div>
                                <div class="col-md-6" v-if="p_category == 1">
                                    <div class="form-group">
                                        ...
                                        <rs-multiselect
                                            v-model="hijos"
                                            :options="category_opens_options"
                                            :multiple="true"
                                            :hide-selected="true"
                                            :close-on-select="false"
                                        ></rs-multiselect>
                                        <small
                                            id="category_openHelp"
                                            class="form-text text-muted"
                                            v-text="msg.category_open"
                                        ></small>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-12 text-right">
                                    ...
                                    >
                                        <span class="fa fa-ok"></span> Guardar
                                    </button>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    data() {
        return {
            ...
            msg: {
                ...
                subcategory_latino:
                    "Seleccione las categorias latinos que participan.",
                subcategory_standar:
                    "Seleccione las categorias standard  que participan.",
    ...
    methods: {
        get() {
            axios.post("/get-tournament").then((response) => {
        ...
        onSelected(e) {
            ...
            axios.post("/upload/" + e.target.id, data).then((response) => {
                this.data[e.target.id] = response.data;
                this.msg[e.target.id] =
                    '<a href="/storage/' +
                    e.target.id +
                    "/" +
                    response.data +
        ...
        getFile(e) {
            ...
            data.append(e.target.id, files[0]);
            axios
                .post("/upload-file/" + this.more_info_.type_id, data)
                .then((response) => {
        ...
        addmore_info() {
            if (
                ...
                if (isNaN(this.more_info_.type_id)) {
                    return toastr.error(
                        "El campo tipo solo admite valore numéricos."
                    );
                }
                if (
                    this.more_info_.type_id == 1 &&
                    this.more_info_.link.indexOf("http")
                ) {
                    return toastr.error(
                        "El link debe ser la direccion completa http://www.dominio.com"
                    );
                }
                this.more_info.push({
        ...
        searchCat(category, subcategory) {
            if (category == 1) {
                for (let i in this.category_opens) {
        ...
        addP() {
            if (this.price && this.p_category) {
                if (isNaN(this.price)) {
                    return toastr.error(
                        "El campo precio solo admite valore numéricos."
                    );
                }
                if (this.price > 200) {
                    return toastr.error(
                        "El campo precio no puede ser tan algo."
                    );
                }
                ...
                for (let i in this.hijos) {
                    ...
                    for (let o in this.prices) {
                        if (
                            data["category_id"] ==
                                this.prices[o]["category_id"] &&
                            data["subcategory_id"] ==
                                this.prices[o]["subcategory_id"]
                        ) {
        ...
        registrar() {
            ...
            for (let i in this.referees) {
                for (let r in this.data.referee_tournament) {
                    if (
                        this.referees[i].name == this.data.referee_tournament[r]
                    ) {
            ...
            if (this.$route.params.id) {
                axios
                    .put("/tournament/" + this.data.id, this.data)
                    .then((response) => {
                        toastr.success("Competencia Actualizada");
                        this.$router.push({ name: "tournament.index" });
                    });
            } else {
                axios.post("/tournament", this.data).then((response) => {
